...
Scope {
    ...
    PanelWindow {
        ...
        Rectangle {
            ...
            height: childrenRect.height * root.blBlobProgress
            width: childrenRect.width * root.blBlobProgress
            // color: "transparent"
            // Rectangle { anchors.fill: parent; color: "#40ffffff"; radius: 8 }
            Text { height: 200; width:root.blobWidth; anchors.centerIn: parent; text: "BL"; color: "white"; font.pixelSize: 14 }
        }
        // bottom right
        Rectangle {
            id: brBlobContent
            ...
            height: childrenRect.height * root.brBlobProgress
            width: childrenRect.width * root.brBlobProgress
            color: "transparent"
            Rectangle { anchors.fill: parent; color: "#4000ffff"; radius: 8 }
            Text { height: 200; width:root.blobWidth; anchors.centerIn: parent; text: "BL"; color: "white"; font.pixelSize: 14 }
        }
        // bottom center
        Rectangle {
            ...
            y: frameWindow.height - root.frameSide("bottom") - height
            x: root.innerGeometry().x + (root.innerGeometry().width - width) * 0.5
            height: childrenRect.height * root.bcBlobProgress
            width: childrenRect.width * root.bcBlobProgress
            color: "transparent"
            Rectangle { anchors.fill: parent; color: "#4000ffff" }
            Text { height: 100; width:500; anchors.centerIn: parent; text: "BL"; color: "white"; font.pixelSize: 14 }
        }
        // top left
        Rectangle {
            id: tlBlobContent
            ...
            x: root.frameSide("left")
            height: childrenRect.height * root.tlBlobProgress
            width: childrenRect.width * root.tlBlobProgress
            color: "transparent"
            Rectangle { anchors.fill: parent; color: "#4000ffff"; radius: 8 }
            Text { height: 10; width:root.blobWidth; anchors.centerIn: parent; text: "BL"; color: "white"; font.pixelSize: 14 }
        }
        // top right
        Rectangle {
            id: trBlobContent
            ...
            y: root.frameSide("top")
            x: frameWindow.width - width - root.frameSide("right")
            height: childrenRect.height * root.trBlobProgress
            width: childrenRect.width * root.trBlobProgress
            color: "transparent"
            Rectangle { anchors.fill: parent; color: "#4000ffff";}
            Text { height: 10; width:300; anchors.centerIn: parent; text: "BL"; color: "white"; font.pixelSize: 14 }
        }
        // top center
        Rectangle {
            id: tcBlobContent
            ...
            y: root.frameSide("top")
            x: root.innerGeometry().x + (root.innerGeometry().width - width) * 0.5
            height: childrenRect.height * root.tcBlobProgress
            width: childrenRect.width * root.tcBlobProgress
            color: "transparent"
            Rectangle { anchors.fill: parent; color: "#4000ffff"; radius: 8 }
            Text { height: 15; width:root.blobWidth; anchors.centerIn: parent; text: "BL"; color: "white"; font.pixelSize: 14 }
        }
        // left
        Rectangle {
            id: leftBlobContent
            ...
            x: root.frameSide("left")
            y: root.innerGeometry().y + (root.innerGeometry().height - height) * 0.5
            height: childrenRect.height * root.leftBlobProgress
            width: childrenRect.width * root.leftBlobProgress
            color: "transparent"
            Rectangle { anchors.fill: parent; color: "#4000ffff"; radius: 8 }
            Text { width: 100; height:500; anchors.centerIn: parent; text: "BL"; color: "white"; font.pixelSize: 14 }
        }
        // right
        Rectangle {
            id: rightBlobContent
            ...
            x: frameWindow.width - width - root.frameSide("right")
            y: root.innerGeometry().y + (root.innerGeometry().height - height) * 0.5
            height: childrenRect.height * root.rightBlobProgress
            width: childrenRect.width * root.rightBlobProgress
            color: "transparent"
            Rectangle { anchors.fill: parent; color: "#4000ffff"; radius: 8 }
            Text { width: 100; height:500; anchors.centerIn: parent; text: "BL"; color: "white"; font.pixelSize: 14 }
        }
